function slideAutoSwitch(images) {
    ...
    $(".slide-img").animate({opacity: 0.1}, 200, function() {
    	$(".slide-pag .widebullet").attr('src', '/modules/slideshow/scripts/images/wide_bullets_2.png');
    	$(".slide-pag .bullet_"+currentIdx).attr('src', '/modules/slideshow/scripts/images/wide_bullets_2_selected.png');
...
function slideSwitch(images, idx) {
    ...
    $(".slide-img").animate({opacity: 0.1}, 50, function() {
    	$(".slide-pag .widebullet").attr('src', '/modules/slideshow/scripts/images/wide_bullets_2.png');
    	$(".slide-pag .bullet_"+idx).attr('src', '/modules/slideshow/scripts/images/wide_bullets_2_selected.png');
